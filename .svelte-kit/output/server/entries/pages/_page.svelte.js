import { c as create_ssr_component, a as subscribe, b as each, d as add_classes, e as escape, v as validate_component, f as add_attribute, h as set_store_value, m as missing_component } from "../../chunks/index2.js";
import "fabric";
...
const History = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="editor-canvas-sidebar-control"><h2>History</h2>
  <ul>${each(data, (list, index) => {
    return `<li${add_classes((list.active ? "active" : "").trim())}><button type="button">${escape(list.name)}</button>
      </li>`;
  })}</ul></article>`;
});
const Selector = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_canvasElement();
  return `<article class="editor-canvas-sidebar-control"><h2>Selector</h2>
  <ul>${each(data, (list, index) => {
    return `${list.type != "circle" && list.type != "line" && list.type != "image" ? `<li><button type="button">${escape(list.type)}</button>
        </li>` : ``}`;
  })}</ul></article>`;
});
const Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="editor-canvas-sidebar">${validate_component(History, "History").$$render($$result, {}, {}, {})}
...
${validate_component(Popper, "Popper").$$render($$result, { contents: "Group" }, {}, {
    default: () => {
      return `<button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V2zm8.5 0v8H15V2H8.5zm0 9v3H15v-3H8.5zm-1-9H1v3h6.5V2zM1 14h6.5V6H1v8z"></path></svg></button>`;
    }
  })}
${validate_component(Popper, "Popper").$$render($$result, { contents: "UnGroup" }, {}, {
    default: () => {
      return `<button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M6 1v3H1V1h5zM1 0a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H1zm14 12v3h-5v-3h5zm-5-1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5zM6 8v7H1V8h5zM1 7a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H1zm14-6v7h-5V1h5zm-5-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1h-5z"></path></svg></button>`;
    }
  })}

${validate_component(Popper, "Popper").$$render($$result, { contents: "Undo" }, {}, {
    default: () => {
      return `<button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"></path></svg></button>`;
    }
  })}
${validate_component(Popper, "Popper").$$render($$result, { contents: "Redo" }, {}, {
    default: () => {
      return `<button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg></button>`;
    }
  })}
${validate_component(Popper, "Popper").$$render($$result, { contents: "Reset" }, {}, {
    default: () => {
      return `<button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"></path><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"></path></svg></button>`;
    }
  })}`;
});
...
const Draw = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_canvasElement();
  return `${validate_component(DrawingOptions, "DrawingOptions").$$render($$result, { variable }, {}, {})}
<div class="editor-icons">${`${validate_component(Popper, "Popper").$$render($$result, { contents: "path" }, {}, {
    default: () => {
    ...
    ${validate_component(Popper, "Popper").$$render($$result, { contents: "polygon" }, {}, {
    default: () => {
      return `<button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M7.779.052a.5.5 0 0 1 .442 0l6.015 2.97a.5.5 0 0 1 .267.34l1.485 6.676a.5.5 0 0 1-.093.415l-4.162 5.354a.5.5 0 0 1-.395.193H4.662a.5.5 0 0 1-.395-.193L.105 10.453a.5.5 0 0 1-.093-.415l1.485-6.676a.5.5 0 0 1 .267-.34L7.779.053zM2.422 3.813l-1.383 6.212L4.907 15h6.186l3.868-4.975-1.383-6.212L8 1.058 2.422 3.813z"></path></svg></button>`;
    }
  })}`}
...
const CanvasEditor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let ctx;
  let imageDrop;
  set_store_value(selectedComponent, $selectedComponent = { name: "shape", component: Shape }, $selectedComponent);
  let component;
  const selectorList = [
  ...
  do {
    $$settled = true;
    $$rendered = `<div class="editor"${add_attribute("this", imageDrop, 0)}><section class="editor-header"><h1>IMAGE EDITOR</h1>
  ...
  ${validate_component(Sidebar, "Sidebar").$$render($$result, {}, {}, {
      default: () => {
        return `<canvas width="1280" height="720"${add_attribute("this", ctx, 0)}></canvas>`;
      }
    })}

...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_fabric: string;
	export const npm_package_dependencies_svelte_popperjs: string;
	export const npm_package_dependencies__popperjs_core: string;
	export const npm_package_dependencies__types_fabric: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_fabric: string;
		npm_package_dependencies_svelte_popperjs: string;
		npm_package_dependencies__popperjs_core: string;
		npm_package_dependencies__types_fabric: string;

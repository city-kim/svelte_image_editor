...
import { sendToBack, bringToFront, copyObject, group, unGroup } from '$lib/js/control'
import { history } from '$lib/js/canvas'

import Popper from '$component/Popper.svelte'

</script>
<Popper contents="BringToFront">
  <button 
    on:click={() => bringToFront($canvasElement)}>
...
<Popper contents="SendToBack">
  <button 
    on:click={() => sendToBack($canvasElement)}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
...
<Popper contents="Copy">
  <button 
    on:click={() => copyObject($canvasElement)}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2z"/>
    </svg>
  </button>
</Popper>
<Popper contents="Group">
  <button 
    on:click={() => group($canvasElement)}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V2zm8.5 0v8H15V2H8.5zm0 9v3H15v-3H8.5zm-1-9H1v3h6.5V2zM1 14h6.5V6H1v8z"/>
    </svg>
  </button>
</Popper>
<Popper contents="UnGroup">
  <button 
    on:click={() => unGroup($canvasElement)}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
...
<Popper contents="Undo">
  <button 
    on:click={() => new history($canvasElement).change({type: 'undo'})}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
    </svg>
  </button>
</Popper>
<Popper contents="Redo">
  <button 
    on:click={() => new history($canvasElement).change({type: 'redo'})}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
    </svg>
  </button>
</Popper>
<Popper contents="Reset">
  <button 
    on:click={() => new history($canvasElement).change({type: 'undo', index: 0})}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
